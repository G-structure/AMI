...
2. Installing the Geo Package

A. Change to the directory that contains the file setup.py and the subdirectory Geo. If 
...
3. Using the Geo Package

The Geo package is on your Python path. To import it into a Python script or session, 
execute:
